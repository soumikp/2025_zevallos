---
title: "HPV Microsimulation — Parameter Table"
subtitle: "Last updated: 2026-05-23 | All costs in 2024 USD | Discount rate applied to costs and QALYs"
format:
  html:
    theme: default
...
<style>
/* Enforce constant table width and aligned columns */
table {
  width: 100% !important;
  table-layout: fixed;
...
/* Set constant column widths across all tables */
...
/* Barebones details/summary styling matching native browser look */
details {
  margin-bottom: 20px;
  padding: 12px;
...
| Annual OPC survivor follow-up cost (years 5+) | `COST_ANNUAL_SURVIVOR` | 2500 | 2024 USD | Gamma(2.5, 1000) | **Mild update from v3 $2,000.** No direct source in uploaded papers; reflects routine surveillance imaging, clinical visits, and management of late effects (xerostomia, dysphagia, dental). Adjusted from prior modeling-study conventions. | Low priority for sensitivity — small absolute contribution to total cost. |
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  sections.forEach((section, index) => {
    ...
    // Create native details and summary elements (very simple, barebones style)
    const details = document.createElement('details');
    const summary = document.createElement('summary');
    summary.innerHTML = heading.innerHTML;
    details.appendChild(summary);
    
    // Wrapper div for content inside details
    ...
    const tableId = `param-table-${index}`;
    table.id = tableId;
    ...
    // Collect introductory paragraphs in section
    const siblingElements = [];
    let current = heading.nextElementSibling;
    while (current && current !== table) {
      siblingElements.push(current);
